...
<tr>
<td>Resolver bytes temporarios ou stream e reutilizar o pipeline atual de anexos sem duplicacao</td>
<td><span style="color:#64748b">&#9679;</span> pendente</td>
</tr>
<tr>
<td>Assegurar limpeza, limites e fail-safe sem alterar dados operacionais</td>
<td><span style="color:#64748b">&#9679;</span> pendente</td>
</tr>
<tr>
<td rowspan="4">GUI</td>
...
<tr>
<td>Preservar cursor, selecao, abas, undo/redo, conteudo e ordem em abrir, editar e salvar</td>
<td><span style="color:#64748b">&#9679;</span> pendente</td>
</tr>
<tr>
...
<td>Cobrir caminhos tradicionais, embedded, MIME suportado, ^^^, preview, salvar, reabrir e envio</td>
<td><span style="color:#64748b">&#9679;</span> pendente</td>
</tr>
<tr>
<td>Cobrir duplicidade, orfandade, Base64 invalido, definicao ausente ou nao utilizada e rollback de atualizacao</td>
<td><span style="color:#64748b">&#9679;</span> pendente</td>
</tr>
<tr>
<td>Executar sintaxe, testes, check, build, validacao dist e bundle</td>
<td><span style="color:#64748b">&#9679;</span> pendente</td>
</tr>
<tr>
<td>Confirmar ausencia de regressao no pipeline, GUI, CLI e distribuicao</td>
<td><span style="color:#64748b">&#9679;</span> pendente</td>
</tr>
<tr>
