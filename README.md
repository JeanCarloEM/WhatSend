...
O andamento operacional das FTs fica em [IMPLEMENTACOES.md](IMPLEMENTACOES.md), gerado por `npm run agents:update`.
...
| `npm run agents:update` | Atualiza o resumo operacional gerado a partir de `continue.ia`. |
